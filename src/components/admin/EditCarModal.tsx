    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-[#1a1a24] rounded-xl shadow-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center p-6 border-b border-gray-200 dark:border-[#2a2a3a] sticky top-0 bg-white dark:bg-[#1a1a24]">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Edit Car</h2>
          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              {formData.existingImages.length > 0 && (
                <div>
                  <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Current Images ({formData.existingImages.length})</p>
              ...
              {formData.existingImages.length + formData.images.length < 5 && (
                ...
                >
                  ...
                  <p className="text-gray-700 dark:text-gray-300 font-medium mb-1">Add more images</p>
              ...
              {newImagePreviews.length > 0 && (
                <div>
                  <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">New Images</p>
